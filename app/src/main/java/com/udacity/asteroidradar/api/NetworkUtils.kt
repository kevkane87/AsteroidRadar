...
//Converter functions for parsing JSON object to database asteroid models
        ...
        if (nearEarthObjectsJson.has(formattedDate)) {
            ...
            for (i in 0 until dateAsteroidJsonArray.length()) {
                ...
                val asteroid = DatabaseAsteroid(
                    ...
                    estimatedDiameter, relativeVelocity, distanceFromEarth, isPotentiallyHazardous, isFavourite
                )
